...
CHOIRpalette <- function(n) {
  ...
  CHOIR_colors <- c("#00CCE3", "#F8A100", "#E81AEF", "#F56900", "#6560FF",
                    "#00D456", "#A25AFF", "#C1D400", "#1990FF", "#E58CCC",
                    "#00DEA3", "#FF5B4B", "#3BA833", "#F7D823", "#AEA9FF",
                    "#FF9C88", "#7DA6CC", "#FF4CF9", "#CB8251", "#61BBFF",
                    "#8B7CFF", "#A99900", "#FCB467", "#83DD00", "#FB798C",
                    "#08A38E", "#67D4D9", "#D98AF7", "#8099FF", "#24B167",
...
#' dimensionality reduction to run UMAP on (e.g., 'P0_reduction', 'P1_reduction').
#' Default = \code{NULL} will run UMAP on all of the dimensionality reductions
#' generated by CHOIR stored under the provided 'key'.
#'
...
#' @param legend A boolean value indicating whether to include a legend. Defaults to
#' \code{TRUE}.
  ...
  if (accuracy_scores == TRUE) {
    ...
    if (proceed == TRUE) {
      ...
      CHOIR_plot <- CHOIR_plot +
        ...
        ggplot2::scale_color_gradientn(colors = c("#F9FB0E", "#FEC832", "#D1BB59", "#92BF73",
                                                  "#2EB7A4", "#06A4CA", "#1481D6", "#0363E1"),
                                       breaks = seq(0,100,5)) +
